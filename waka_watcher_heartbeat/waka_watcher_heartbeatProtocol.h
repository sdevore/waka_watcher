//
//  waka_watcher_heartbeatProtocol.h
...
@protocol waka_watcher_heartbeatProtocol
...
initWithServiceName:@"com.scidsolutions.waka-watcher-heartbeat"];
     _connectionToService.remoteObjectInterface = [NSXPCInterface
interfaceWithProtocol:@protocol(waka_watcher_heartbeatProtocol)];
